...
# python generate.py sample_images/tubingen.jpg -m models/out.model -o sample_images/output.jpg
# python generate.py sample_images/tubingen.jpg -m models/starrynight.model -o sample_images/output1.jpg

# python generate.py sample_images/tubingen.jpg -m models/composition.model -o sample_images/outputCompsition.jpg