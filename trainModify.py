...
for epoch in range(n_epoch):
    ...
    for i in range(n_iter):
        ...
        L_feat0 = lambda_f * F.mean_squared_error(Variable(feature[0].data), feature_hat[0])
        L_feat1 = lambda_f * F.mean_squared_error(Variable(feature[1].data), feature_hat[1])
        L_feat2 = lambda_f * F.mean_squared_error(Variable(feature[2].data), feature_hat[2])
        L_feat3 = lambda_f * F.mean_squared_error(Variable(feature[3].data), feature_hat[3])

        L_feat = L_feat0 + L_feat1 + L_feat2 + L_feat3
...
# python train.py -s sample_images/style_2.png -d models -g 0

# not gpu mode
# python train.py -s sample_images/style_2.png -d models -g -1 -e 100
# python train.py -s sample_images/style_2.png -d models -g -1 -e 10000